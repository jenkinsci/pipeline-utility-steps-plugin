...
public class FileSha256VerifyStepTest {
    ...
    public void configRoundTrip() throws Exception {
        FileSha256VerifyStep step = new FileSha256VerifyStep("f.txt", "hash");
        FileSha256VerifyStep step2 = new StepConfigTester(j).configRoundTrip(step);
    ...
    public void emptyFile() throws Exception {
        ...
        p.setDefinition(new CpsFlowDefinition(
                "node('slaves') {\n" +
                        "  dir('test') {\n" +
                        "    touch 'empty.txt'\n" +
                        "    sha256Verify(file: 'empty.txt', hash: 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855')\n" +
                        "  }\n" +
                        "}", true));
    ...
    public void failsOnMismatch() throws Exception {
        ...
        p.setDefinition(new CpsFlowDefinition(
                "node('slaves') {\n" +
                        ...
                        "    sha256Verify(file: 'fail.txt', hash: 'ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad')\n" +
                        "  }\n" +
                        "}", true));
    ...
    public void failsIfFileNotFound() throws Exception {
        ...
        p.setDefinition(new CpsFlowDefinition(
                "node('slaves') {\n" +
                        "  dir('test') {\n" +
                        "    sha256Verify(file: 'nonexistent.txt', hash: 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855')\n" +
                        "  }\n" +
                        "}", true));
        final WorkflowRun run = j.assertBuildStatus(Result.FAILURE, p.scheduleBuild2(0));
